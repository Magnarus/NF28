...
{
    RectTransform myRT; // Référence sur son propre rectTransform
    RectTransform parentRT; // Référence sur le parent dans la hierarchie

    /** A chaque trigger du script, on récupère les infos**/
    void Awake()
    {
